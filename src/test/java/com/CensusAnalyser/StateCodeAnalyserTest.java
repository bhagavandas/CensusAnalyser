...
public class StateCodeAnalyserTest {
	...
	private static final String INDIA_CENSUS_CSV_FILE_PATH = "./src/test/resources/IndiaStateCode.txt";
	private static final String WRONG_CSV_FILE_PATH = "./src/main/IndiaStateCode.csv";
